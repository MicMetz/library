export const Readings = [
...

  {
    ...
    description: [
      ...
      'So widely documented is the participation of the School’s graduates in torture, murder, and political repression throughout Latin America that in 2001 the School officially changed its name to the Western Hemisphere Institute for Security Cooperation. Lesley Gill goes behind' +
      ' the façade and presents a comprehensive portrait of the School of the Americas. Talking to a retired Colombian general accused by international human rights organizations of terrible crimes, sitting in on classes, accompanying soa students and their families to an upscale local' +
